...
#     parser.add_argument('--out_dir', default='./data/plate_test', help='output dir')
#     parser.add_argument('--make_num', default=10000, type=int, help='num')
#     parser.add_argument('--img_w', default=272, type=int, help='num')
#     parser.add_argument('--img_h', default=72, type=int, help='num')
...
#     env = cv2.imdecode(np.fromfile(data_set[index], dtype=np.uint8), -1)
...
#G.genBatch(33,2,range(31,65),"./testImg",(272,72))
#G.genBatch(10,2,range(31,65),"./plate_test",(272,72))
